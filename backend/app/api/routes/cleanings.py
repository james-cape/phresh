...
from app.api.dependencies.cleanings import check_cleaning_modification_permissions
...
async def delete_cleaning_by_id(
    ...
    deleted_id = await cleanings_repo.delete_cleaning_by_id(cleaning=cleaning)
